...
internal object Translit {
    ...
    private val CLASSES: List<List<String>> = listOf(
        ...
        // Односимвольные `y` и `i` из класса убраны сознательно. Замена идёт по всей строке
        // сразу, поэтому они не порождают полезных частичных вариантов («dmitrii» превращался
        // в «dmytryy», а не в «dmitriy»), зато порождают вредные: шаблон «IT» раскрывался в `yt`
        // и ловил `BYTOVAYA TEHNIKA`. Расширение блокировки мусорными вариантами — это ровно
